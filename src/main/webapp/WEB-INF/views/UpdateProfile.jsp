...
<div>
<br>
<form:form method="post" action="${pageContext.request.contextPath}/UpdateProfileToDB" style="width: 20%;margin: auto;" modelAttribute="Customers">
  ...
  <div class="form-group">
    ...
    <form:input disabled="true" name="email" path="email" type="text" placeholder="Email Addresss...." class="form-control" />
