...
<jsp:include page="adminheader.jsp"></jsp:include>
	...
	<table class="table table-striped" style="margin: auto; width: 95%;">
		...
		<tbody>
			...
			<td><a href="ViewOneProduct/${x.getId()}" class="btn btn-primary">View</a></td>
			<td><a onclick="return confirm('Are you sure ?');" href="DeleteOneProduct/${x.getId()}" class="btn btn-danger">Block</a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
